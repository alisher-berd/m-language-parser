...
export function testFunctionExpression(parserFunction) {
    describe("function-expression, valid inputs", () => {
        runTestSuitesToEqual(
            "./test/parser/parsers/58-parseFunctionExpression/testCases",
            /^test-suite-/,
            (input) => {
